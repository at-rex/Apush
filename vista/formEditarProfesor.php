                        ...
                        <form class="form-1" action="../controlador/getProfesor.php" method="POST">
                            ...
                            <div class="row-input">
                                 <div class="contenedor_input">
                                    ...
                                    <input type="text" placeholder="Ingrese apellido materno" name="txtNombre"  value= "<?php echo $profesor[1] ?>" required >
                                </div>

                                <div class="contenedor_input">
                                    <label class="labe" for="">Apellido paterno:</label>  
                                    <input type="text" placeholder="Ingrese usuario" name="txtApepat" value= "<?php echo $profesor[2] ?>" required>
                                </div>

                                <div class="contenedor_input">
                                    <label class="labe" for="">Apellido Materno:</label>  
                                    <input type="text" placeholder="Ingrese Contraseña" name="txtApemat" value= "<?php echo $profesor[3] ?>" required>
                                </div>

                                 <div class="contenedor_input">
                                    <label class="labe" for="">DNI:</label>  
                                    <input type="text" placeholder="Ingrese Contraseña" name="txtDni" value= "<?php echo $profesor[4] ?>" required>
                                </div>
